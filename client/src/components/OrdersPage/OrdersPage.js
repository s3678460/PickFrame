...
class OrdersPage extends Component {
  ...
  render() {
    ...
    const linkImage =
      process.env.PUBLIC_URL + `/storageimages/${imageTarget.originalImage}`;
                ...
                >
                  ...
                  <div className="form-group">
                    <input
                      type="text"
                      className={classnames("form-control form-control-lg", {
                        "is-invalid": errors.companyPhone
                      })}
